...
router.get('/orders/:id', protect, adminOnly, orderController.getOrderDetails);

router.get('/orders/:id/status', protect, adminOnly, orderController.getOrderStatusHistory);
