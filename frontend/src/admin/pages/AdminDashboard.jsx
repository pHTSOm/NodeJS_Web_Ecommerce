    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        setStats({
          ...
          totalOrders: 0, // Placeholder - implement order counting when available
          revenue: 0 // Placeholder - implement revenue calculation when available
        });
        ...
        <Col lg="8">
          <Card className="mb-4">
            <CardHeader className="d-flex justify-content-between">
              ...
              <Link to="/admin/products" className="text-decoration-none">View All</Link>
            </CardHeader>
            <CardBody>
              {loading ? (
